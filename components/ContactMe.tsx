...
const ContactMe = (props: Props) => {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row sm:max-w-7xl px-10 justify-evenly mx-auto items-center md:space-x-10">
      <div className="text-sm uppercase tracking-[20px] text-gray-500 top-24 absolute sm:text-2xl">
        Contact
      </div>
